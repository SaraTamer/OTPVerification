...
sender = 'sasooelbihery@gmail.com'
password = 'gqzgjvqlqdhtuzur'
code = generateOTP()
...
sendOTP = Button(otp, text="send OTP", width=8, height=1, font=("Arial", 20), borderwidth=0, bg="#AA5656", fg="white", command=connectingSender)
...
verify = Button(otp, text="Verify", width=8, height=1, font=("Arial", 20), borderwidth=0, bg="#AA5656", fg="white",
                command=checkOTP)
